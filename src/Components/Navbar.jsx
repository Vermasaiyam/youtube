...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between px-4 h-[60px] items-center bg-[#212121] opacity-95 text-white sticky' >
            ...
            <div className='flex items-center justify-center gap-2 mr-9'>
                <form onSubmit={(e) => {
                    ...
                    <div className='flex bg-zinc-900 items-center h-10 px-4 pr-0 rounded-3xl '>
                        ...
                        <button className='h-10 w-12 flex items-center justify-center bg-zinc-800 rounded-r-3xl' onClick={()=> dispatch(changeSearchTerm(searchTerm))}>
                            <IoMdSearch className='flex items-center text-2xl cursor-pointer' />
                        </button>

                    </div>
                </form>
                <div className='bg-zinc-900 rounded-full p-3 hover:bg-zinc-700 cursor-pointer' onClick={()=> alert("Microphone under Construction. Thanks!!!")}>
